...
export default function CreateAdmin() {
  ...
  const [role, setRole] = useState(""); // user must select role
    ...
    <div className="w-full h-screen bg-[url(/login-bg.jpg)] bg-cover bg-center flex">
      ...
      <div className="flex w-[50%] h-full items-center justify-center">
        <div className="w-[450px] h-[700px] backdrop-blur-md shadow-xl rounded-[10px] flex flex-col justify-center items-center">
          <h1 className="text-black text-2xl">Create Admin</h1>

          <input
            value={firstName}
            onChange={(e) => setFirstName(e.target.value)}
            className="w-[400px] h-[45px] border border-white rounded-xl text-center m-[5px] mt-[50px]"
            type="text"
          ...
          <select
            ...
            className="w-[400px] h-[45px] border border-white rounded-xl text-center m-[5px] bg-transparent"
          >
